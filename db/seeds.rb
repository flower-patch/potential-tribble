...
ProjectTemplate.create( name: "Twin-Sized Quilt", example_thumb_url: "twin_quilt.png", description: "Make a twin sized quilt")
ProjectTemplate.create( name: "Lap Quilt", example_thumb_url: "lap_quilt.png", description: "Make a lap quilt")
